    ...
    <div className="bg-gray-100 w-full pb-20">
      <div className=" mx-auto px-12 ">
        <div className="mt-6 px-10">
          ...
          <h1 className="text-2xl uppercase font-bold  pb-6 text-third text-center italic">
              Information profile
            </h1>

          </div>
          <div className="w-full   bg-white mt-8  border py-8 px-8 border-gray-200 rounded-md">
